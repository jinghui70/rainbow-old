...
public class KTableCellEditorMultilineText extends KTableCellEditor {
	...
	public void open(KTable table, int col, int row, Rectangle rect) {
		...
		Object content = m_Model.getContentAt(m_Col, m_Row, false);
		m_Text.setText(content == null ? "" : content.toString());
		m_Text.selectAll();
	...
	protected Control createControl() {
		m_Text = new Text(m_Table, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
