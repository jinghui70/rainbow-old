...
public abstract class Utils {
	...
	public static <T extends IIdObject<I>, I> Map<I, T> idMap(List<T> list) {
		return Maps.uniqueIndex(list, Utils.<T, I> toIdFunction());
	}
	...
	/**
	 * Returns a function that transfer object to json string;
	 */
	public static Function<Object, String> toJsonFunction = new Function<Object, String>() {
		@Override
	...
	public static <T> List<T> filter(Iterable<T> src, Predicate<T> predicate) {
		return Lists.newArrayList(Iterables.filter(src, predicate));
	}

	public static DefaultJSONParser getParser(String input, ClassLoader classLoader) {
		ParserConfig config = new ParserConfig(classLoader);
		config.putDeserializer(LocalDateTime.class, JodaCodec.instance);
		config.putDeserializer(LocalDate.class, JodaCodec.instance);
		config.putDeserializer(LocalTime.class, JodaCodec.instance);
		config.putDeserializer(DateTime.class, JodaCodec.instance);
		config.putDeserializer(Period.class, JodaCodec.instance);
		config.putDeserializer(Duration.class, JodaCodec.instance);
		config.putDeserializer(Instant.class, JodaCodec.instance);
		return new DefaultJSONParser(input, config);
	}

	static {
		ParserConfig.getGlobalInstance().putDeserializer(LocalDateTime.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(LocalDate.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(LocalTime.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(DateTime.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(Period.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(Duration.class, JodaCodec.instance);
		ParserConfig.getGlobalInstance().putDeserializer(Instant.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(LocalDateTime.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(LocalDate.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(LocalTime.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(DateTime.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(Period.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(Duration.class, JodaCodec.instance);
		SerializeConfig.getGlobalInstance().put(Instant.class, JodaCodec.instance);
	}
}
